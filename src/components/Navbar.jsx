	...
	<div className="navbar container">
		<div className="navbar_main">
			<div className="navbar_logo">
				<svg viewBox="0 0 111 30" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" aria-hidden="true" role="img" className="logo">
					<g>
			...
			<div className="navbar_lang-signin">
				<button><i className="fa-solid fa-globe"></i><span>English</span><i className="fa-solid fa-caret-down"></i></button>
